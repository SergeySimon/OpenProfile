...
This is the stable branch, the application should be stable. this branch is an OpenProfile build created to run on a jailbroken iDevice inside of Mobile Terminal or any other terminal emulating application. **[Doesn't run the _start_ procedure, currently in broken state.]**
